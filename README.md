<h3 align="center"><b>Go Fundme Page</b></h3>
...
# 📖 Go Fundme Page<a name="about-project"></a>

The **Go Fundme Page** is a learning project. The goal is to use Stripe api to handle payments.
